...
console.log('Direct your browser to localhost:8080/operations/least_square/client.html.');
console.log('To run a server-based party: node operations/least_square/party <input');
console.log();
